...
void SearchResult::fromJson(const web::json::value& val)
{
...
utility::string_t SearchResult::getContent() const
{
    return m_Content;
}

void SearchResult::setContent(const utility::string_t& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool SearchResult::contentIsSet() const
{
    return m_ContentIsSet;
}

void SearchResult::unsetContent()
{
    m_ContentIsSet = false;
}

bool SearchResult::isDisabled() const
{
    return m_Disabled;
}

void SearchResult::setDisabled(bool value)
{
    m_Disabled = value;
    m_DisabledIsSet = true;
}

bool SearchResult::disabledIsSet() const
{
    return m_DisabledIsSet;
}

void SearchResult::unsetDisabled()
{
    m_DisabledIsSet = false;
}

utility::string_t SearchResult::getName() const
{
    return m_Name;
}

void SearchResult::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SearchResult::nameIsSet() const
{
    return m_NameIsSet;
}

void SearchResult::unsetName()
{
    m_NameIsSet = false;
}

utility::string_t SearchResult::getObjectType() const
{
    return m_Object_type;
}

void SearchResult::setObjectType(const utility::string_t& value)
{
    m_Object_type = value;
    m_Object_typeIsSet = true;
}

bool SearchResult::objectTypeIsSet() const
{
    return m_Object_typeIsSet;
}

void SearchResult::unsetObject_type()
{
    m_Object_typeIsSet = false;
}

utility::string_t SearchResult::getZoneId() const
{
    return m_Zone_id;
}

void SearchResult::setZoneId(const utility::string_t& value)
{
    m_Zone_id = value;
    m_Zone_idIsSet = true;
}

bool SearchResult::zoneIdIsSet() const
{
    return m_Zone_idIsSet;
}

void SearchResult::unsetZone_id()
{
    m_Zone_idIsSet = false;
}

utility::string_t SearchResult::getZone() const
{
    return m_Zone;
}

void SearchResult::setZone(const utility::string_t& value)
{
    m_Zone = value;
    m_ZoneIsSet = true;
}

bool SearchResult::zoneIsSet() const
{
    return m_ZoneIsSet;
}

void SearchResult::unsetZone()
{
    m_ZoneIsSet = false;
}

utility::string_t SearchResult::getType() const
{
    return m_Type;
}

void SearchResult::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SearchResult::typeIsSet() const
{
    return m_TypeIsSet;
}

void SearchResult::unsetType()
{
    m_TypeIsSet = false;
}

int32_t SearchResult::getTtl() const
{
    return m_Ttl;
}

void SearchResult::setTtl(int32_t value)
{
    m_Ttl = value;
    m_TtlIsSet = true;
}

bool SearchResult::ttlIsSet() const
{
    return m_TtlIsSet;
}

void SearchResult::unsetTtl()
{
    m_TtlIsSet = false;
}
